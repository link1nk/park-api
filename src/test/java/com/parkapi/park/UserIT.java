...
public class UserIT {
	...
	@Test
	public void createUsuario_ComUsernameEPasswoedValidos_RetornarUsuarioCriadoComStatus201() {
	...
	@Test
	public void createUsuario_ComUsernameRepetido_RetornarErrorMessageComStatus209() {
		ErrorMessage responseBody = testClient
			.post()
			.uri("/api/v1/users")
			.contentType(MediaType.APPLICATION_JSON)
			.bodyValue(new UsuarioCreateDTO("little@email.com", "123456"))
			.exchange()
	...
	public void buscarUsuario_ComIdExistente_RetornarUsuarioComStatus200() {
		...
		org.assertj.core.api.Assertions.assertThat(responseBody.getUsername()).isEqualTo("little@email.com");
	...
	@Test
	public void editarSenha_ComSenhaInvalidos_RetornarErrorMessageComStatus400() {
		ErrorMessage responseBody = testClient
			.patch()
			.uri("/api/v1/users/100")
			.contentType(MediaType.APPLICATION_JSON)
			.bodyValue(new UserPasswordDTO("123456", "123456", "223456"))
			.exchange()
